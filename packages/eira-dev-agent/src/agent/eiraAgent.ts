...
import { AgentStateSchema, AgentState, getArchitectAgent } from './eira.js';
...
async function architectNode(state: AgentState) {
...
async function customToolsNode(state: AgentState): Promise<{ messages: ToolMessage[] }> {
...
// --- The Router Logic ---
function routeFromArchitect(state: AgentState): 'tools' | typeof END {
