...
const askHumanForHelpSchema = z.object({
  question: z.string().describe(
    "The specific, clear question you need to ask the human to resolve your current situation or get approval."
  ),
  context: z.string().optional().describe(
    "Optional additional context the agent can provide to the human, such as the current task, file being worked on, or a summary of why help is needed."
  ),
});
