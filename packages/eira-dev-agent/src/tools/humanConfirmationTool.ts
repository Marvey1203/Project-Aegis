...
export const humanConfirmationTool = new DynamicStructuredTool({
  ...
  description:
    "Call this tool when you have a complete plan and need the user's confirmation before proceeding with execution. This will pause the execution and wait for human input. The plan MUST be fully described in the text part of your response before calling this tool.",
  schema: z.object({
