...
type AddKnowledgeBaseEntryInput = z.infer<typeof addKnowledgeBaseEntrySchema>;

async function addKnowledgeBaseEntryLogic(input: AddKnowledgeBaseEntryInput): Promise<string> {
  try {
